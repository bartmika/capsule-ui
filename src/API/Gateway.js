...
import {
    CAPSULE_LOGIN_API_ENDPOINT,
    CAPSULE_VERSION_ENDPOINT,
    CAPSULE_LOGOUT_API_ENDPOINT,
    CAPSULE_FORGOT_PASSWORD_API_ENDPOINT,
    CAPSULE_PASSWORD_RESET_API_ENDPOINT,
    CAPSULE_EXECUTIVE_VISITS_TENANT_API_ENDPOINT,
    CAPSULE_DASHBOARD_API_ENDPOINT
} from "../Constants/API";
...
export function postLoginAPI(data, onSuccessCallback, onErrorCallback, onDoneCallback) {
    ...
    customAxios.post(CAPSULE_LOGIN_API_ENDPOINT, decamelizedData).then((successResponse) => {
...
export function getVersionAPI(onSuccessCallback, onErrorCallback, onDoneCallback) {
    ...
    customAxios.get(CAPSULE_VERSION_ENDPOINT).then((successResponse) => {
        const responseData = successResponse.data;
...
export function postLogoutAPI(onSuccessCallback, onErrorCallback, onDoneCallback) {
    ...
    let data = {};
    customAxios.post(CAPSULE_LOGOUT_API_ENDPOINT, data).then((successResponse) => {
...
export function postForgotPasswordAPI(email, onSuccessCallback, onErrorCallback, onDoneCallback) {
    ...
    customAxios.post(CAPSULE_FORGOT_PASSWORD_API_ENDPOINT, {email: email}).then((successResponse) => {
...
export function postPasswordResetAPI(verificationCode, password, passwordRepeat, onSuccessCallback, onErrorCallback, onDoneCallback) {
    ...
    customAxios.post(CAPSULE_PASSWORD_RESET_API_ENDPOINT, {verification_code: verificationCode, password: password, password_repeated: passwordRepeat}).then((successResponse) => {
        console.log("postForgotPasswordAPI: Success")
        onSuccessCallback(); // Return the callback data.
    }).catch( (exception) => {
        let responseData = null;
...
export function postExecutiveVisitsTenant(tenantID, onSuccessCallback, onErrorCallback, onDoneCallback) {
    ...
    axios.post(CAPSULE_EXECUTIVE_VISITS_TENANT_API_ENDPOINT, data).then((successResponse) => {
        const responseData = successResponse.data;
...
export function getDashboardAPI(onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
    ...
    customAxios.get(CAPSULE_DASHBOARD_API_ENDPOINT).then((successResponse) => {
        const responseData = successResponse.data;
