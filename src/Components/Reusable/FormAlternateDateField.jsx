        ...
        <div class="field pb-4">
            ...
            <div class="control">
                <div class="columns is-mobile">
                    ...
                    <div class="column" style={{maxWidth:"75px"}}>
                        <span class="is-fullwidth">
                            Day
                            <input class={classNameText} type="text" placeholder="DD" maxlength="2" value={day} onChange={(e)=>{onDayChange(e.target.value)}} />
                        </span>
                    ...
                    <div class="column" style={{maxWidth:"75px"}}>
                        <span class="is-fullwidth">
                            Month
                            <input class={classNameText} type="text" placeholder="MM" maxlength="2" value={month} onChange={(e)=>{onMonthChange(e.target.value)}} />
                        </span>

                    </div>
                    <div class="column" style={{maxWidth:"90px"}}>
                        <span class="is-fullwidth">
                            Year
                            <input class={classNameText} type="text" placeholder="YYYY" maxlength="4" value={year} onChange={(e)=>{onYearChange(e.target.value)}} />
                        </span>
                    </div>
                </div>
            </div>
