                        ...
                        <section class="hero is-medium is-link">
                            <div class="hero-body">
                                ...
                                <p class="subtitle">
                                    ...
                                    <br />
                                    <br />
                                    <Link to={"/page/detail/second/6541c860fa17876a9dd04f1f"}>Second&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>
                                </p>
                            </div>
                        </section>
                        ...
                        <section class="hero is-medium is-link">
                            <div class="hero-body">
                                ...
                                <p class="subtitle">
                                    ...
                                    <br />
                                    <br />
                                    <Link to={"/page/add/second"}>Second&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>
                                </p>
                            </div>
                        </section>
