...
export function setAccessTokenInLocalStorage(accessToken) {
    if (accessToken !== undefined && accessToken !== null) {
        localStorage.setItem("CAPSULE_TOKEN_UTILITY_ACCESS_TOKEN_DATA", accessToken);
    } else {
...
export function setRefreshTokenInLocalStorage(accessToken) {
    if (accessToken !== undefined && accessToken !== null)  {
        localStorage.setItem("CAPSULE_TOKEN_UTILITY_REFRESH_TOKEN_DATA", accessToken);
    } else {
...
export function getAccessTokenFromLocalStorage() {
    return localStorage.getItem("CAPSULE_TOKEN_UTILITY_ACCESS_TOKEN_DATA");
}
...
export function getRefreshTokenFromLocalStorage() {
    return localStorage.getItem("CAPSULE_TOKEN_UTILITY_REFRESH_TOKEN_DATA");
}
...
export function clearAllAccessAndRefreshTokensFromLocalStorage() {
    localStorage.removeItem("CAPSULE_TOKEN_UTILITY_ACCESS_TOKEN_DATA");
    localStorage.removeItem("CAPSULE_TOKEN_UTILITY_REFRESH_TOKEN_DATA");
}
